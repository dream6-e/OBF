"""Luraph v14.7 devirtualizer engine, adapted from the v15 engine."""
import re
import sys
...
class LuraphV147(Obfuscator):
    ...
    def add_arguments(self, ap):
        g = ap.add_argument_group("Luraph v14.7")
    ...
    def deobfuscate(self, job):
        from obfuscators.luraph_v14_7 import driver
