"""
Luraph v14.9 devirtualizer (front end + driver): lifts the VM protos
...
flow. The IR and the back end are shared (ir.py, backend.py).
    ...
    python obfuscators/luraph_v14_9/devirt.py <src> <protos.json> [--all OUT | --raw KEY | --lift KEY | --op ...]
...
from obfuscators.luraph_v14_9 import vmmap  # noqa: E402
