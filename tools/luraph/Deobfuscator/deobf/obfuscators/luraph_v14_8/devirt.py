"""
Luraph v14.8 devirtualizer (front end + driver): lifts the VM protos
...
flow. The IR and the back end are shared (ir.py, backend.py).
    ...
    python obfuscators/luraph_v14_8/devirt.py <src> <protos.json> [--all OUT | --raw KEY | --lift KEY | --op ...]
...
from obfuscators.luraph_v14_8 import vmmap  # noqa: E402
