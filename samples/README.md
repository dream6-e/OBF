...
| 文件 | 说明 |
|---|---|
| `print.obfuscated.lua`    | `test/print.lua`（557 B）的普通模式产物，104,051 B |
| `print.obfuscated.MB.lua` | 同一输入的 MB 模式产物（加壳 + 二次压缩），55,075 B |
| `U4f2aU88c5.obfuscated.lua` | 仓库根目录 `#U4f2a#U88c5.lua`（“伪装.lua”，12,365 B）的普通模式产物，139,172 B |
